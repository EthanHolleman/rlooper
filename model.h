...
public:
    ...
    virtual void compute_structure(std::vector<char>& sequence, const std::vector<char>::iterator &start, const std::vector<char>::iterator &stop, Structure& previous_structure, Structure& current_structure) = 0;
